...
import net.kagani.game.player.content.Slayer.SlayerTask;
...
public class SlayerManager implements Serializable {
	...
	private void addPoints() {
		...
		pointsIncreased *= Settings.getDropQuantityRate(player);
	...
	private void openSocialInvitation(final Player otherPlayer) {
		...
		player.getPackets().sendIComponentText(1310, 10,
				"" + otherPlayer.getSkills().getCombatLevelWithSummoning());
