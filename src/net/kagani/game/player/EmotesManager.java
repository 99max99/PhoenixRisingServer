...
public final class EmotesManager implements Serializable {
	...
	public void useBookEmote(int id) {
		...
		if (id == 2) {// Yes
			...
			case 32054:
			case 32055:
				player.getDialogueManager().startDialogue("SimpleMessage", "Not letting you do this, bitch - Dylan Page");
				break;
			case 19709:
			case 19710:
			...
			player.getMusicsManager().playMusicEffect(502);
	...
	public void unlockEmotesBook() {
		player.getPackets().sendUnlockIComponentOptionSlots(590, 8, 0, 169, 0, 1);
