...
public class FarmingManager implements Serializable {
	...
	private static final int ALLOTMENT = 0, TREES = 1, HOPS = 2, FLOWERS = 3,
			...
			BELLADONNA = 9, HARMONY_PILLAR = 10;
	...
	public static enum ProductInfo {
		...
		HarmonyPillar(-1, 75, 6055, 0, 0, 512, 0, 1, 0, HARMONY_PILLAR);
	...
	public static enum SpotInfo {
		...
		Gnome_Strong_Fruit_Tree(7962, FRUIT_TREES), Gnome_Fruit_Tree(7963,
				...
				7965, FRUIT_TREES), Lletya_Fruit_Tree(28919, FRUIT_TREES),
		...
		HarmonyPillar(94324, HARMONY_PILLAR),
		HarmonyPillar1(94325, HARMONY_PILLAR),
		HarmonyPillar2(94326, HARMONY_PILLAR),
		HarmonyPillar3(94327, HARMONY_PILLAR);
//		HARMONY_PILLAR_N(94324, HARMONY_PILLAR), HARMONY_PILLAR_E(94326, HARMONY_PILLAR), 
//		HARMONY_PILLAR_S(94325, HARMONY_PILLAR), HARMONY_PILLAR_W(94327, HARMONY_PILLAR)}
		...
		player.getActionManager().setAction(new Action() {
			...
			public int processWithDelay(Player player) {
				...
				if (spot.productInfo.type == HERBS) {
					player.getSkillTasks().decreaseTask(SkillTasks.HERB1);
					player.getSkillTasks().decreaseTask(SkillTasks.HERB2);
					player.getSkillTasks().decreaseTask(SkillTasks.HERB3);
					player.getSkillTasks().decreaseTask(SkillTasks.HERB4);
				} else if (spot.productInfo.type == FLOWERS) {
					player.getSkillTasks().decreaseTask(SkillTasks.FLOWER1);
					player.getSkillTasks().decreaseTask(SkillTasks.FLOWER2);
					player.getSkillTasks().decreaseTask(SkillTasks.FLOWER3);
					player.getSkillTasks().decreaseTask(SkillTasks.FLOWER4);
				} else if (spot.productInfo.type == FRUIT_TREES) {
					player.getSkillTasks().decreaseTask(SkillTasks.FRUIT1);
					player.getSkillTasks().decreaseTask(SkillTasks.FRUIT2);
					player.getSkillTasks().decreaseTask(SkillTasks.FRUIT3);
					player.getSkillTasks().decreaseTask(SkillTasks.FRUIT4);
				} else if (spot.productInfo.type == ALLOTMENT) {
					player.getSkillTasks().decreaseTask(SkillTasks.VEG1);
					player.getSkillTasks().decreaseTask(SkillTasks.VEG2);
					player.getSkillTasks().decreaseTask(SkillTasks.VEG3);
					player.getSkillTasks().decreaseTask(SkillTasks.VEG4);
				}
	...
	public boolean startFarmingCycle(FarmingSpot spot, Item item) { // check if
		...
		if (!player.getInventory().containsItemToolBelt(isTree ? 952 : 5343)) {
			...
			player.getPackets().sendGameMessage(
					"You need a farming level of " + level + " to plant this "
							+ (isTree ? "sapling" : "seed") + ".");
			return true;
		}
		player.getPackets().sendGameMessage(
	...
	public boolean startCureAction(final FarmingSpot spot, final Item item) {
		...
		if (!spot.isDiseased()) {
			...
			if (!(player.getInventory().containsItemToolBelt(5329) || player
				...
				player.getPackets().sendGameMessage(
						"You need a pair of secatures to prune the tree.");
			}
		}
		player.getPackets().sendGameMessage(
