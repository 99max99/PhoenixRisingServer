...
import net.kagani.game.npc.others.CastleWarBarricade;
...
public class CastleWarsPlaying extends Controller {
	...
	public boolean processObjectClick1(WorldObject object) {
		...
		if (id == 4406 || id == 4407) {
			...
			return false;
		} else if ((id == 36579 && team == CastleWars.SARADOMIN)
				|| (id == 36586 && team == CastleWars.ZAMORAK)) { // Bandages
			// table
			...
			else if (object.getX() == 2417 && object.getY() == 3075
					&& object.getPlane() == 1)
				player.useStairs(-1, new WorldTile(2417, 3078, 0), 0, 1);
			...
			if (object.getX() == 2417 && object.getY() == 3077)
		 ...
		 */
			...
			World.spawnObject(new WorldObject(4437, object.getType(), object
					.getRotation(), object.getX(), object.getY(), object
					.getPlane()));
		}
		return true;
	}
