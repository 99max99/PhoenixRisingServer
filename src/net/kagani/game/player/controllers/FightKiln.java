...
import net.kagani.game.npc.fightkiln.FightKilnNPC;
import net.kagani.game.npc.fightkiln.HarAken;
import net.kagani.game.npc.fightkiln.TokHaarKetDill;
...
public class FightKiln extends Controller {
	...
	public static void enterFightKiln(Player player, boolean quickEnter) {
		...
		if (player.containsOneItem(23653, 23654, 23655, 23656, 23657, 23658))
			return;
		player.getControlerManager().startControler("FightKilnControler",
				quickEnter ? 1 : 0);
	}
								...
								public void run() {
									if (count == 0) {
										...
										tokHaarHok = new NPC(TOKHAAR_HOK_SCENE,
												...
												true);
										tokHaarHok.setDirection(Utils.getAngle(
												1, 0));
