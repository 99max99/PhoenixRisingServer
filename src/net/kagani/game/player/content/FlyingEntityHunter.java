...
public class FlyingEntityHunter {
	...
	public enum FlyingEntities {
		...
		ESSENCE_IMPLING(1032, 11246, 160, 225, 42, new Item[] {
				new Item(562, 4), new Item(554, 50) /*
													 * Fire rune
													 */,
				new Item(555, 30) /*
								 * Water rune
		...
		ECLECTIC_IMPLING(1033, 11248, 205, 289, 50,
				new Item[] { new Item(1273, 1) /*
						...
						new Item(5321, 3) /*
										 * Watermelon seed
										 */, }, new Item[] { new Item(1391, 1),
						new Item(1601, 1) }),

		SPIRIT_IMPLING(7866, 15513, 227, 321, 54, new Item[] {
				new Item(12155, 25), new Item(12109, 1) /*
														 * Cockatrice egg
														 */,
				new Item(12113, 1) /*
									 * Saratrice egg
				...
				new Item(2361, 1) /*
								 ...
								 */, new Item(2363, 1) /*
														 ...
														 */, new Item(1115, 1),
				new Item(1120, 2)
				/* Steel platebody */, new Item(1636, 10),
				new Item(2135, 25) /*
									 * Raw rat meat
									 */, new Item(2139, 25),
				new Item(9979, 15) /*
				...
				new Item(7939, 1) /*
								 * Tortoise shell
								 */, new Item(6291, 1),
				new Item(6319, 1) /* Proboscis */, new Item(2860, 3),
				new Item(237, 1) /*
								 * Unicorn horn
								 */, new Item(10149, 1),
				new Item(2151, 5) /*
								 * Swamp toad
								 */, new Item(12156, 1) /* Honeycomb */,
				new Item(1934, 14), new Item(6033, 12) /* Compost */,
				new Item(6010, 1) /* Marigolds */, new Item(12148, 3),
				new Item(12134, 1) /*
									 * Evil turnip
									 */, new Item(12153, 1),
				new Item(1520, 65) /*
									 * Willow logs
									 */, new Item(5934, 2),
				new Item(1964, 25) /* Banana */, new Item(8431, 2),
				new Item(3138, 1) /*
								 * Potato cactus
								 */, new Item(2462, 1), new Item(249, 4) /*
																		 ...
																		 * guam
																		 */,
				new Item(951, 18) /* Tinderbox */,
				new Item(311, 14) /* Harpoon */, new Item(6980, 5),
				new Item(1442, 1), new Item(1438, 1) /*
													 * Air talisman
													 */, new Item(572, 2) /*
																		 * Water
																		 * orb
																		 */,
				new Item(9737, 2), new Item(9976, 4) /* Chinchompa */,
		...
		NATURE_IMPLING(1034, 11250, 250, 353, 58, new Item[] {
				...
				new Item(5285, 1) /*
								 ...
								 */, new Item(5286, 1), new Item(5313, 1) /*
																		 ...
																		 * seed
																		 */,
				new Item(5974, 1) /* Coconut */, }, new Item[] {
				new Item(5304, 1) /*
								 * Torstol seed
		...
		NINJA_IMPLING(6053, 11254, 339, 481, 74, new Item[] {
				...
				new Item(9342, 1), new Item(6155, 1) /*
													 * Dagannoth hide
													 */}, new Item[] {
				new Item(2363, 1) /*
								 * Rune bar
	...
	public static void captureFlyingEntity(final Player player, final NPC npc) {
		...
		if (System.currentTimeMillis() - player.lastImpling < 200000) {
			long totalTime = System.currentTimeMillis() - player.lastImpling;
			long sec = 200 - totalTime / 1000;
			long min = sec / 20;
			player.getPackets().sendGameMessage(
					"You need to wait " + min
							+ " minutes before you can catch another impling.");
			return;
		}
		player.lock(2);
			...
			public void run() {
				if (isSuccessful(player, instance.getLevel(),
						new DynamicFormula() {
							...
							public int getExtraProbablity(Player player) {
								if (player.getEquipment().getItem(3).getId() == 11259)
									return 3;// magic net
								else if (player.getEquipment().getItem(3)
										.getId() == 10010)
					...
					if (player.getInventory().addItem(
						...
						player.getSkillTasks().decreaseTask(SkillTasks.NET1);
						player.getSkillTasks().decreaseTask(SkillTasks.NET2);
						player.getSkillTasks().decreaseTask(SkillTasks.NET3);
						player.getSkillTasks().decreaseTask(SkillTasks.NET4);
	...
	public static boolean isSuccessful(Player player, int dataLevel,
		...
		/*
		 * int hunterlevel = player.getSkills().getLevel(Skills.HUNTER); int
