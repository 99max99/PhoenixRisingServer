...
import net.kagani.game.player.content.dungeoneering.rooms.HandledRoom;
import net.kagani.game.player.content.dungeoneering.rooms.NormalRoom;
import net.kagani.game.player.content.dungeoneering.rooms.RoomEvent;
import net.kagani.game.player.content.dungeoneering.rooms.StartRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.ColouredRecessRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.CrystalPuzzleRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.FishingFerretRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.FlipTilesRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.FlowerRootsRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.FremennikCampRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.LeverRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.PoltergeistRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.ReturnTheFlowRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.SlidingStatuesRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.SlidingTilesRoom;
import net.kagani.game.player.content.dungeoneering.rooms.puzzles.ToxinMaze;
...
public class DungeonConstants {
	...
	public static enum Puzzle {
		...
		CRYSTAL_PUZZLE(12, CrystalPuzzleRoom.class, all(spot(13, 5))), TOXIN_MAZE(20, ToxinMaze.class, all(spot(7, 8)),
				false), FLIP_TILES(24, FlipTilesRoom.class,
						list(spot(1, 3), spot(1, 12), spot(1, 3), spot(14, 11), spot(14, 11), spot(1, 9),
								spot(1, 3))), FREMENNIK_CAMP(26,
										FremennikCampRoom.class,
										list(spot(6, 14), spot(10, 2), spot(14, 6), spot(5, 12),
												spot(13, 10), spot(3,
														5),
								spot(13, 10))), FISHING_FERRET(32, FishingFerretRoom.class, all(spot(2, 1)),
										false), LEVERS(38, LeverRoom.class,
												list(spot(1, 5), spot(10, 14), spot(1, 5), spot(10, 14), spot(1,
														5), spot(10, 14),
												spot(1, 5))), SLIDING_STATUES(42, SlidingStatuesRoom.class,
														all(spot(1, 3)), false), FLOWER_ROOTS(50, FlowerRootsRoom.class,
	...
	static {
		...
		for (Puzzle puzzle : Puzzle.values()) {
			...
			if (!Settings.HOSTED) {
				 ...
				 * progress one on live instead replace it with last added one
				 * (more bug testers!) puzzle = Puzzle.SLIDING_STATUES; }
				 */
	...
	public static final int[][] HOARDSTALKER_ITEMS = {
			...
			{ 17630, 17424, 17682, 17448, 17797 }, { 17632, 17426, 17684, 17450, 17799 },
			{ 17634, 17428, 17686, 17452, 17801 }, { 17636, 17430, 17688, 17454, 17803 },
			{ 17638, 17432, 17700, 17456, 17805 }, { 17640, 17434, 17702, 17458, 17807 },
			{ 17642, 17436, 17704, 17460, 17809 }, { 17644, 17438, 17706, 17462, 17811 },
			{ 17646, 17440, 17708, 17464, 17813 }, { 17648, 17442, 17710, 17466, 17815 }
