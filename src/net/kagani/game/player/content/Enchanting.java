...
public class Enchanting {
	...
	private static short[][] JEWLERY_NODES = { { 1694, 1637, 1658, 11072 },
			{ 1639, 1658, 1696, 11076 }, { 1641, 1660, 1698, 11086 },
			{ 1643, 1662, 1700, 11092 }, { 1645, 1664, 1702, 11115 },
			{ 6575, 6581, 6577, 11130 } };
	private static short[][] JEWLERY_PRODUCT = { { 1727, 2550, 3853, 11074 },
			{ 2552, 12622, 1729, 11079 }, { 2568, 11194, 1725, 11088 },
			{ 2570, 11090, 1731, 11095 }, { 2572, 11105, 1712, 11118 },
			{ 6583, 6585, 11128, 11133 } };
	private static int[][] JEWLERY_RUNES = { { 564, 1, 555, 1 },
	 ...
	 * Bolt stuff
	 */
	private static short[] BOLT_NODES = { 879, 9337, 9335, 880, 9338, 9336,
			9339, 9340, 9341, 9342 };
	private static short[] BOLT_PRODCUTS = { 9236, 9240, 9237, 9238, 9241,
			9239, 9242, 9243, 9244, 9245 };
	private static int[][] BOLT_RUNES = { { 564, 1, 556, 2 },
	...
	private static double[] BOLT_EXPERIENCE = { 9, 17, 19, 29, 37, 33, 59, 67,
			78, 97 };
