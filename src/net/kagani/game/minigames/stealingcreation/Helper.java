...
public class Helper {
	...
	public static final int[] CLASS_ITEMS_BASE = { 14132, 14122, 14142, 14152,
			14172, 14162, 14367, 14357, 14347, 14411, 14401, 14391, 14337,
			14327, 14317, 14297, 14287, 14307, 14192, 14202, 12850, 12851,
	...
	public static void awardPoints(Player player, Score personal, int winner) {
		...
		if (points > 0) {
			points *= Settings.getDropQuantityRate(player);
			player.setCompletedStealingCreation();
			player.increaseFinishedStealingCreations();
